...
const Login = () => {
    ...
    return (
        <div className="login-form py-5 text-center">
            <div className="p-5">
                <h2 className="mt-5">{loggedInUser.email}</h2>
                <div>
                    <h3 className="mb-3 fw-bold" style={{ color: 'rgb(116, 31, 143)' }}>Please Login</h3>
                    ...
                    <br />
                    <p>New to Our Site ? <Link to='/signup' className="fw-bold">Create Account</Link></p>
                    <br /> 
                    <div>
